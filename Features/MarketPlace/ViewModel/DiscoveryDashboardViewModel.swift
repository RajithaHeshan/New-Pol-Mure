...
class DiscoveryDashboardViewModel {
    ...
    var unreadNotificationCount = 3 // Controls the HIG-compliant red badge
    
    // Map State (Default: Kaduwela)
    ...
    var filteredRecommendedLots: [HarvestLot] {
        ...
        case "Ending Soon":
            results = results.filter { $0.endDate.timeIntervalSinceNow < 172800 }
        case "Nearest to Me":
